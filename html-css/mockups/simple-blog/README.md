...
- If homework is taking you super long to complete:
    - Go to TA hours
...
- If you're zipping through the homework
...
4. TEST YOUR WORK AS YOU GO! Make sure that your code works `node name_of_your_file.js`.
...
```
const favMovies = ['The Last Samurai', 'Remember the Titans', 'Hoodwinked', 'A Lot Like Love', 'La La Land', 'Guardians of the Galaxy 2', 'Boondock Saints', 'We are the Millers', 'Lord of the Rings', 'Pulp Fiction', 'Harry Potter', 'Death at a Funeral(The Brittish Version)', 'Bright', 'Star Wars IV,V,VI', 'Step Brothers', 'Goodfellas', 'The Dark Knight', 'Shawshank Redemption', 'Sixth Sense', 'Kill Bill', 'Spiderman: Into the Spiderverse', 'Kill Bill Volume 2', 'Gladiator', 'The Godfather', 'Fight Club', 'Star Trek: First Contact', 'Apollo 13' , 'Se7en' ]
```

- Console log:  the index of `Guardians of the Galaxy 2`
...
- Do the following and console.log the final results (I have included some *thought* questions, you don't have to write out an answer for those marked as such):
 ...
 1. `push` "Spiderman Homecoming"
 1. Reverse the array
 1. Use the `shift` method
 1. Now use the `unshift` method to add "Lilo and Stitch" - thought question: what does it return?
 1. `splice` "Bright" and add "Murder Mystery" (try finding the index of "Bright", instead of counting it yourself) Thought question: did this permanently alter our array?
...
- After running the above tasks, console.log the index of "Se7en"
    -We previously removed it from the array, what value do we get when we look for the index of something that is not in the array?
...
## Part II: HTML/CSS Mockup 

### Getting Started 

1. In today's homework folder, create a `mockup` directory 
1. `cd` into the mockup directory and recreate the files `styles.css` and `index.html` 
...
>🐘 Reminder:
>Using the command `open index.html` inside the terminal when you are inside the folder with your index.html file will open your app in your browser.
...
## Part III: EXTRA, Hungry for More?

<details><summary><strong>Click for some bonus problems!</strong></summary><p>

#### Lab Time Revisited

We didn't get a chance to hop into lab today, so take a look at the [lab markdowns](https://git.generalassemb.ly/Software-Engineering-Immersive-Remote/SEIR-Stitch/tree/master/unit_1/w01d05/student_labs) and work on those problems!
...
<hr>
&#x1F534; The commit message should read: <br>
"Hungry for More: I tackled some HFM problems"
<hr>
...
## Deliverables
**There are two parts to this weekend homework**, JavaScript reps and code challenges and a CSS mockup. Make sure to try and attempt both sections!

## Submission Guidelines

- Must be submitted no later than 10 AM Eastern before the start of next class
- Forgot how to submit homework? Look at the submission guidelines from [yesterday's homework!](https://git.generalassemb.ly/Software-Engineering-Immersive-Remote/SEIR-Stitch/tree/master/unit_1/w01d04/homework) 
